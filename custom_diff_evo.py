...
def minimize(get_costs, bounds, popsize, mutate, recombination, maxiter, population:list=None):
    ...
    for i in range(1,maxiter+1):
        ...
        # COST FUNCTION (step #3.C) 
        costs = get_costs(v_trials+population) 
        ...
        for j in range(0, popsize):
            ...
            if score_trial < score_target:
                ...
                print( '   >',score_target, population[j])
